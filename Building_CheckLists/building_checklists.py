...
matches = mu.read_csv('matches.csv')
            ...
            for dlxs_record in dlxs:
                if match[1] == dlxs_record[1]:
                    ...
                    if "keywords" not in match[4]:
                        ...
                        best_entry.append(None)
                        check_keywords.append([match[0],match[1],alma_record[8],dlxs_record[11], f"https://search.lib.umich.edu/catalog/record/{match[0]}", f"https://quod.lib.umich.edu/p/philamer/{match[1]}" ])
...
list_name = ["best_matches","check_author","check_language", "check_pub_place", "check_publication_date", "check_publisher", "check_keywords"]


best_matches.insert(0, ["mms_id", "dlxs_id", "title", "author", "publication place", "publisher", "publications date", "language", "notes", "keywords" ])
full_lists = [best_matches,check_author,check_language, check_pub_place, check_publication_date, check_publisher, check_keywords]
